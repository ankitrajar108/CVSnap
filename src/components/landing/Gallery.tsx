...
const ImageGallery = () => {
  ...
  return (
    <div className="w-full bg-mainBlack py-20 sm:py-32">
      <div className="max-w-section mx-auto px-section">
        <h2 className="text-3xl font-semibold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-center mb-8 text-white">
        ...
        <div className="mt-16 space-y-16">
          {people.map((person, index) => (
            <div
              key={index}
              className="bg-gray-900/50 border border-white/10 rounded-2xl overflow-hidden shadow-2xl shadow-black/20"
            >
              <div
              ...
              >
                ...
                <div className="w-full md:w-1/2 relative aspect-[4/5]">
                  ...
                  <div className="absolute bottom-4 right-4 bg-black/50 text-white backdrop-blur-sm text-xs px-2 py-1 rounded-md border border-white/10">
                    AI GENERATED
                  </div>
                </div>
              </div>
