...
const FeatureCard = ({
  ...
  <div className="bg-gray-900/50 border border-white/10 p-6 rounded-xl shadow-lg transition-all duration-300 hover:border-cyan-400/50 hover:bg-gray-900 group">
    <div className="flex items-start mb-4">
      <div className="bg-gradient-to-br from-cyan-400 to-blue-500 p-3 rounded-full mr-4">
      ...
      <div className="max-w-section mx-auto px-section">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center">
            <span className="text-cyan-400 text-2xl mr-2 hidden sm:inline">✨</span>
