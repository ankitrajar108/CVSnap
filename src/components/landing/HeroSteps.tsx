...
const Step: React.FC<(typeof steps)[0] & { isFirst: boolean }> = ({
  ...
  <div className="group flex-1 relative bg-gray-900/50 border border-white/10 rounded-xl p-6 transition-all duration-300 hover:border-cyan-400/50">
    <div className="absolute -top-3 -left-3 bg-gradient-to-br from-cyan-400 to-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold text-sm">
      {number}
    </div>
    <div className="flex items-start mb-4">
      <div className="bg-gradient-to-br from-cyan-400 to-blue-500 text-white p-3 rounded-full mr-4">
