...
export const metadata: Metadata = {
  ...
  description: "Sign up to create AI-powered professional headshots in minutes.",
};
          ...
          <div className="bg-[#FCFBF7] p-8 rounded-lg border border-gray-200 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
            ...
            >
              ...
              <PasswordInput
                ...
                required
              />
              <AuthButton pendingText="Signing Up...">Sign Up</AuthButton>
            ...
            <div className="w-full">
              <GoogleSignInButton formAction={signUpWithGoogle} pendingText="Signing up with Google...">
            ...
            <p className="text-xs text-gray-500 text-center mt-4">
              By registering, you agree to the CVSNAP{" "}
              <Link
                href="/terms"
